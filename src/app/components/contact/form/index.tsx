        ...
        <div className="container mx-auto lg:max-w-screen-xl md:max-w-screen-md">
          <div className="grid md:grid-cols-12 grid-cols-1 gap-8 items-center">  
            <div className="col-span-6">
              <h2 className="max-w-72 text-[40px] leading-[1.2] font-bold mb-9">Solicita tu consulta online</h2>
              <form onSubmit={handleSubmit} className="flex flex-wrap w-full m-auto justify-between">
                <div className="sm:flex gap-3 w-full">
                  <div className="mx-0 my-2.5 flex-1">
                    <label htmlFor="first-name" className="pb-3 inline-block text-17">Nombre*</label>
                    <input
                      id='firstname'
                      type='text'
                      name='firstname'
                  ...
                  <div className="mx-0 my-2.5 flex-1">
                    <label htmlFor="last-name" className="pb-3 inline-block text-17">Apellido*</label>
                    <input
                      id='lastname'
                      type='text'
                      name='lastname'
                ...
                <div className="sm:flex gap-3 w-full">
                  <div className="mx-0 my-2.5 flex-1">
                    <label htmlFor="email" className="pb-3 inline-block text-17">Correo electrónico*</label>
                    <input
                      id='email'
                      type='email'
                      name='email'
                  ...
                  <div className="mx-0 my-2.5 flex-1">
                    <label htmlFor="Specialist" className="pb-3 inline-block text-17">Especialista*</label>
                    <select  
                    name="specialist"
                      id="specialist"
                      ...
                      <option value="Promoción efectiva">Promoción efectiva</option>
                    </select>
                  </div>
                </div>
                <div className="sm:flex gap-3 w-full">
                  <div className="mx-0 my-2.5 flex-1">
                    <label htmlFor="date" className="pb-3 inline-block text-17">Fecha*</label>
                    <input
                       id='date'
                      type='date'
                      name='date'
                  ...
                  <div className="mx-0 my-2.5 flex-1">
                    <label htmlFor="time" className="pb-3 inline-block text-17">Hora*</label>
                    <input
                      id='time'
                      type='time'
                      name='time'
